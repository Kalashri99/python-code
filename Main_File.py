...
def ExtractLocaters(sentencearr, textarr, data, worddict):  # data is dictionary of input and its value ,worddict->empty dictionary
    ...
    def text_function_textbox1(word):
        ...
        input_tags = ["input","label","span","textarea","p","div"]
        ...
        for tag in input_tags:
            for attr in input_attrs:
                ...
                xpath = "//{}[@{}='{}'] | //{}[contains(normalize-space(),'{}')]/following::input[@type='text' or @type='password'][1]".format(tag, attr, word, tag, word, tag, attr, tag)
                try:
                    input_elems= driver.find_elements(By.XPATH,xpath)
                    #break  # stop searching when the element is found
                    
                    for input_elem in input_elems:
                        
                        try:
                            input_elem.send_keys(data[j])
    ...
    def text_function_button1(word):
        input_tags = ["input","button",'a',"label","span","summary"]
...
file_path = "D:\RGI Project Documents\RGI-Feature testcase3.docx"
